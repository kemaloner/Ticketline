...
public class SimpleAuthenticationRestClient implements AuthenticationRestClient {
    ...
    public AuthenticationToken authenticate(final AuthenticationRequest authenticationRequest) throws DataAccessException {
        try {
            ...
            throw new DataAccessException(BundleManager.getExceptionBundle().getString("authentication.failed"), e);
    ...
    public AuthenticationToken authenticate() throws DataAccessException {
        try {
            ...
            throw new DataAccessException(BundleManager.getExceptionBundle().getString("authentication.token.failed"), e);
        } catch (RestClientException e) {
            throw new DataAccessException(BundleManager.getExceptionBundle().getString("exception.cannot_connect_to_server"), e);
        }
    }
    ...
    public AuthenticationTokenInfo tokenInfoCurrent() throws DataAccessException {
        try {
            ...
            throw new DataAccessException(BundleManager.getExceptionBundle().getString("authentication.token.info.failed"), e);
        } catch (RestClientException e) {
            throw new DataAccessException(BundleManager.getExceptionBundle().getString("exception.cannot_connect_to_server"), e);
        }
    }
